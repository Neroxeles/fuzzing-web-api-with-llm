...
!git clone -b easy2 https://github.com/Neroxeles/fuzzing-web-api-with-llm.git
...
!python3 /content/fuzzing-web-api-with-llm/Fuzzer/main.py "/content/fuzzing-web-api-with-llm/configs/config-files/colab-testing.yml"
